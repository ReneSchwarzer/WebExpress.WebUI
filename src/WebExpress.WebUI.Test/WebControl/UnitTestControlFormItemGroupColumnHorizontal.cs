...
namespace WebExpress.WebUI.Test.WebControl
{
    ...
    public class UnitTestControlFormItemGroupColumnHorizontal
    {
        ...
        /// </summary>
        [Theory]
        [InlineData(null, @"<div class=""form-group-column-horizontal""></div>")]
        [InlineData("id", @"<div id=""id"" class=""form-group-column-horizontal""></div>")]
        ...
        [Theory]
        [InlineData(null, @"<div class=""form-group-column-horizontal""></div>")]
        [InlineData("abc", @"<div class=""form-group-column-horizontal""></div>")]
