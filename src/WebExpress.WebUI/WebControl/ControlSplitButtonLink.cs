...
//            {
//                button.OnClick = $"new webexpress.webui.modalFormCtrl({{ close: '{I18N.Translate(context.Culture, "webexpress.webui:form.cancel.label")}', uri: '{Modal.Uri?.ToString() ?? button.Href}', size: '{Modal.Size.ToString().ToLower()}', redirect: '{Modal.RedirectUri}'}});";
//                button.Href = "#";
//            }
//            else if (Modal.Type == TypeModal.Brwoser)
//            {
//                button.OnClick = $"new webexpress.webui.modalPageCtrl({{ close: '{I18N.Translate(context.Culture, "webexpress.webui:form.cancel.label")}', uri: '{Modal.Uri?.ToString() ?? button.Href}', size: '{Modal.Size.ToString().ToLower()}', redirect: '{Modal.RedirectUri}'}});";
//                button.Href = "#";
//            }
