...
//                    {
//                        html.Elements.Add(new HtmlElementFormOption() { Value = s.Value, Text = I18N.Translate(context.Culture, s.Text), Selected = (s.Value == Value) });
//                    }
//                }
//                else
//                {
//                    html.Elements.Add(new HtmlElementFormOption() { Value = v.Value, Text = I18N.Translate(context.Culture, v.Text), Selected = (v.Value == Value) });
//                }
//            }
