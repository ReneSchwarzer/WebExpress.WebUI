...
//            {
//                button.OnClick = $"new webexpress.webui.modalFormCtrl({{ close: '{I18N.Translate(context.Culture, "webexpress.webui:form.cancel.label")}', uri: '{Modal.Uri}', size: '{Modal.Size.ToString().ToLower()}', redirect: '{Modal.RedirectUri}'}});";
//            }
//            else if (Modal.Type == TypeModal.Brwoser)
//            {
//                button.OnClick = $"new webexpress.webui.modalPageCtrl({{ close: '{I18N.Translate(context.Culture, "webexpress.webui:form.cancel.label")}', uri: '{Modal.Uri}', size: '{Modal.Size.ToString().ToLower()}', redirect: '{Modal.RedirectUri}'}});";
//            }
